...
void main() {
  group('GoogleHealthExerciseDataManager', () {
    ...
    test('fetch() returns parsed exercise sessions and unchanged credentials',
        () async {
      ...
      final client = MockClient((request) async {
        if (request.url.path == '/v4/users/me/dataTypes/exercise/dataPoints') {
          endpointHit = true;
      ...
      expect(result.data.first.activityType, 'running');
      expect(result.data.first.distanceMeters, 6200.0);
