...
class GoogleHealthWeightDataManager
  ...
  /// Fetches weight data for the time range specified by [url].
  ///
  /// Refreshes the access token automatically if expired. Returns a record
  /// containing the list of [GoogleHealthWeightData] points and the (possibly
  ...
  Future<
      ({
        List<GoogleHealthWeightData> data,
