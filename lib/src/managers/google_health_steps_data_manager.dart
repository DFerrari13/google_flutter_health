...
class GoogleHealthStepsDataManager
  ...
  /// Fetches step count data for the time range specified by [url].
  ///
  /// Refreshes the access token automatically if expired. Returns a record
  /// containing the list of [GoogleHealthStepsData] points and the (possibly
  ...
  Future<
      ({
        List<GoogleHealthStepsData> data,
